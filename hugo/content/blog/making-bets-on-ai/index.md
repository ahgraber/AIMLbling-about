...
Let us first assume that a tool (AI Assistant) exists that can complete generic, day-to-day _tasks_ for a white-collar job (i.e., a job that consists of working on a computer). Adoption of AI tools will likely follow the "typical" S-shaped adoption curve we have seen over history; it will not be a binary off -> on switch.
...
Having equivalent tools and assistants for generic white-collar work suggests that all white-collar workers would use AI like software engineers currently do. Recall from the _Anthropic Economic Index_ that software engineers accounted for 37% of requests but only 3% of US workforce[^AEI]; for all other occupations to "catch up" to the "early adopter" phase of software engineering use, it would mean an _**11x**_ increase in use of AI! Of course, that 11x increase implies that software engineering use remains consistent and in a persisted "early adopter" phase; this is unrealistic, and we should expect SWE use to increase as adoption follows the S-curve.
...
I think it is incredibly short-sighted for organizations to close the "top of funnel" by replacing entry-level roles with AI. Even if AI can do the same work, you lose the ability to onboard the next generation with your business practices and knowhow. Additionally, you miss opportunities for transfer of knowledge -- current college students are already much more AI-native than most middle-age workers; their fresh insights might empower new AI-native practices.
...
It is hard to estimate what the new job roles (or even industries) may look like since there is not really a precedent; as a result, this optimistic interpretation of the influence of AI on employment seems more farfetched than the pessimistic one. Armin Ronacher, the creator of Flask and Jinja2 (among other projects), wrote:

_"The job of programmers and artists will change, but they won't vanish. I feel like all my skills that I learned as a programmer are more relevant than ever, just with a new kind of tool. Likewise the abundance of AI generated art also makes me so much more determined that I want to hire an excellent designer as soon as I can. People will always value well crafted products. AI might raise the bar for everybody all at once, but it's the act of careful deliberation and very intentional creation that sets you apart from everybody else."_ ... _"Right now it's messy and raw, but the path is clear: we are no longer just using machines, we are now working with them._"[^optimism]
