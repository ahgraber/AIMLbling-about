...
At the end of 2023, I was transferred to the team working on [PMI Infinity](https://www.pmi.org/infinity), a (then-nascent) AI-powered tool and product for Project Managers, to act as an AI/ML Engineer and provide expertise on the AI/ML aspects of developing a product based on generative models.
Coming from more standard data science and machine learning, my impostor syndrome flared and I felt behind the 8-ball.
I'd been cursorily following LLMs, but had thus far been generally unimpressed by ChatGPT (though I did find Phind to be quite good for coding-related questions).
...
Ultimately, this lead to me collecting interesting and applicable research, demos, packages, and conversations, and sharing it in as an informal newsletter.
...
[Here are all of the links](./treadmill_2024.csv), in (roughly) temporal order of inclusion in AI Treadmill newsletter (deduplication may have thrown off the order here and there)
