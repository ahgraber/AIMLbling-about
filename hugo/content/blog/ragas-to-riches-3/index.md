...
LLMs appear to be more objective judges than I anticipated. **In no experiment was there an obvious evaluator bias toward answers generated by the same model.** I ran several regression models to examine the interaction effects that the retriever, response model and evaluator model selections had on metrics.
