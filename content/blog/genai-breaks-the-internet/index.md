...
<!-- Additionally, models might generate seemingly-verbatim sequences without having seen the original data,
implying that verbatim replication may not (always) be memorization as we think of it but rather that the original is simply the linguistically most-likely sequence based on a generalized language understanding.  -->
