...
This is part two of a three-part series ([one]({{< ref "/blog/ragas-to-riches-1" >}}), three) where I explore best practices for evaluating RAG architecture via Ragas' recent v0.2 release.
